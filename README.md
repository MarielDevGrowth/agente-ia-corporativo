...
datos_empresa.csv: Base de conocimientos de preguntas frecuentes comerciales y de atención al cliente.

protocolo_operaciones.txt: Manual de procedimientos operativos, normas de higiene, seguridad y políticas internas de ausencias y licencias.

empleados_rh.json: Registro estructurado de la nómina de personal, roles, turnos de trabajo y días de vacaciones.
...
Configurar la variable de entorno GEMINI_API_KEY:
